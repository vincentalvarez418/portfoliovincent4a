        ...
        <FadeInWrapper>
          <div className="day-content">
            <div className="image-block">
              <LazyLoadImage
                src={day62}
                alt="Indigenous Tribes of Baguio"
                effect="blur"
                preload="true"
              />
              <p className="image-description">
        ...
        <FadeInWrapper>
          <div className="day-content">
            <div className="image-block">
              <LazyLoadImage
                src={day66}
                alt="Panoramic View from Bell Tower"
                effect="blur"
                preload="true"
              />
              <p className="image-description">
        ...
        <FadeInWrapper>
          <div className="day-content">
            <div className="image-block">
              <LazyLoadImage
                src={day68}
                alt="Sunrise Over Strawberry Farm"
                effect="blur"
                preload="true"
              />
              <p className="image-description">
