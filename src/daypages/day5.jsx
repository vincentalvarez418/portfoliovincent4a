      ...
      <div className="day-page">
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day51} alt="LRT Train Docking Bay" effect="blur" />
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day52} alt="LRT CCTV Control Center" effect="blur" />
            <p className="image-description">
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day53} alt="Empty Train Rails in Warehouse" effect="blur" />
            <p className="image-description">
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day54} alt="LRT Multiple Track Lines" effect="blur" />
            <p className="image-description">
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day55} alt="Inactive LRT Interior" effect="blur" />
            <p className="image-description">
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day56} alt="Government Compound Buildings" effect="blur" />
            <p className="image-description">
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day57} alt="Active LRT Interior" effect="blur" />
            <p className="image-description">
        ...
        <div className="day-content">
          <div className="image-block">
            <LazyLoadImage src={day58} alt="MMDA Briefing Table" effect="blur" />
            <p className="image-description">
